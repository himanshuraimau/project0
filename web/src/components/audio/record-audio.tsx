...
export default function RecordAudio({
  ...
  const [microphonePermission, setMicrophonePermission] = useState<
    "granted" | "denied" | "prompt" | "checking" | null
  >(null);
              ...
              <div className="text-center text-sm">
                ...
                {microphonePermission === "prompt" && (
                  <div className="text-amber-600 dark:text-amber-400 font-medium">
                    Click "Start Recording" and allow microphone access when
                    prompted.
                  </div>
                )}
              </div>
            ...
            <div className="flex gap-2">
              {!isRecording ? (
                <Button
                  ...
                  className="flex-1 h-12 rounded-lg text-white gradient-element disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Mic />
                  {microphonePermission === "checking"
            ...
            {audioBlob && (
              <div className="space-y-4 p-6 rounded-xl bg-accent/10 border border-accent/20">
                ...
                <div>
                  <label
                    htmlFor="fileName"
                    className="block text-sm text-left text-foreground mb-2"
                  >
                    File Name (Optional)
                  </label>
                  <Input
                    ...
                    className="h-10 dark:bg-neutral-800/50 dark:border-neutral-800 dark:text-neutral-400 rounded-lg placeholder:text-text-neutral-400 focus:border-accent/50 transition-colors"
                  />
                </div>
                ...
                <Button
                  ...
                  className="w-full h-12 rounded-lg font-medium bg-green-500 text-white "
                >
                  {isProcessing ? (
                    <>

  ...
  async generateAINote(
    ...
    try {
      ...
      const result = await generateText({
        ...
        Create educational content that's informative and well-structured with selective visual formatting that keeps learners engaged and focused!
        ...
        **Continued Learning:**
        ...
        - Use selective emojis to highlight major sections and key points
        - Create clear organization with structured formatting
        - Utilize **bold**, *italics*, and other text formatting effectively
        - Include numbered and bulleted lists for clarity
...
- 🛡️ **Risk Mitigation:** Potential challenges and proactive solutions (200-300 words)
- 📊 **Success Metrics:** KPIs, measurement frameworks, and evaluation criteria (200-250 words)
- 🗺️ **Implementation Roadmap:** Step-by-step execution plan with checkpoints and decision points (300-400 words)

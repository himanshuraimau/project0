...
export default (theme: BrutalistTheme) => StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '700', color: '#0F172A', marginBottom: 8, fontFamily: theme.fontFamily.heading },
  subtitle: { fontSize: 16, color: '#374151', marginBottom: 16, fontFamily: theme.fontFamily.heading },

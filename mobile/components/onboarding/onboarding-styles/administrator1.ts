...
export default (theme: BrutalistTheme) => StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '700', marginBottom: 8, fontFamily: theme.fontFamily.heading },
  subtitle: { color: '#6B7280', fontSize: 14, marginBottom: 16, fontFamily: theme.fontFamily.heading },
